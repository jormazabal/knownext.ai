...
Version 2.0.4 runs as a self-contained native app on Windows and Android:
...
There is no external product service, packaged auxiliary runtime, API port, or mobile workstation dependency in 2.0.4.

## Download

The latest installers are published on GitHub Releases:

- [Download KnowNext.ai for Windows](https://github.com/jormazabal/knownext.ai/releases/latest/download/KnowNext.ai_2.0.4_x64_en-US.msi)
- [Download KnowNext.ai for Android arm64](https://github.com/jormazabal/knownext.ai/releases/latest/download/KnowNext.ai-android-arm64-v2.0.4.apk)
