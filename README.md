...
Version 2.0.1 runs as a self-contained native app on Windows and Android:
...
There is no external product service, packaged auxiliary runtime, API port, or mobile workstation dependency in 2.0.1.
