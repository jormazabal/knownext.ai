...
- A previously installed version can update or, at minimum, the published MSI can install over it without deleting app data.
...
- Pointing the updater manifest to NSIS when the intended in-app update path is MSI.
