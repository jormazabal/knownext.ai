...
- The document tree goes through `src/lib/api/projects.ts` and reflects folders, Markdown files, supported image assets, and supported support files under the active project's local folder.
